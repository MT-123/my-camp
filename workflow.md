...
K. docker
  - mongoDB
     ...
     2. download mongo image by "docker pull mongo:latest"
        - find mongo image and its id by "docker images"
        - create network:
        ...
        - Important!! stop mongoDB before stop container, go to container terminal and command: % "mongosh" "use admin" "db.shutdownServer()"
  ...
  - mycamp
    ...
    - improve container process by docker-compose
